---
title: "06：子 Agent——大任务拆小，每个拿到的都是干净上下文"
description: "Mini Claude Code 中文文档第 06 篇：子 Agent——大任务拆小，每个拿到的都是干净上下文。"
pubDate: 2026-07-09
tags: ["Claude Code", "Agent", "AI 工程"]
series: "Claude Code"
---

# 06：子 Agent——大任务拆小，每个拿到的都是干净上下文
